...
export const UserFlowersSidebar = forwardRef<
  HTMLDivElement,
  UserFlowersSidebarProps
>(
  (
    { username, onClose, plantedFlowers, setPlantedFlowers, onWaterFlower },
    ref
  ) => {
    ...
    return (
      <div
        ref={ref}
        className="absolute top-0 right-0 h-full w-80 bg-custom-dark text-custom-text backdrop-blur-sm shadow-lg border-l border-custom-secondary/30 z-20 overflow-hidden flex flex-col"
      >
        {" "}
        ...
        <div className="flex-1 overflow-y-auto">
          {userFlowers.length === 0 ? (
            <div className="p-4 text-center text-custom-text/70">
              You haven't planted any flowers yet
            </div>
          ) : (
...
UserFlowersSidebar.displayName = "UserFlowersSidebar";
